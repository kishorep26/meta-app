        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 hero-content">
                    ...
                    <p class="hero-subtitle">Join a community of learners, innovators, and leaders. Experience world-class education that transforms lives.</p>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Access a wide range of courses across multiple disciplines, designed by industry experts and academic leaders.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Learn from experienced professors and industry professionals dedicated to your academic success.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">State-of-the-art labs, libraries, and digital resources to enhance your learning experience.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Dedicated placement cell with strong industry connections to launch your career.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Your voice matters. Share feedback and help us continuously improve our programs.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="testimonial-card">
                        <p class="testimonial-text">"The trainer's in-depth knowledge about the concepts is rare and highly appreciated. This program transformed my career!"</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="testimonial-card">
                        <p class="testimonial-text">"The website is easy to access and user-friendly. Registration and course selection was seamless!"</p>
                        <div class="testimonial-author">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="testimonial-card">
                        <p class="testimonial-text">"Overall it was a great experience and lifetime memory. The faculty and placement support were exceptional!"</p>
                        <div class="testimonial-author">
