            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-12" style="text-align:center;">
                        <h2> Displaying Student Details</h2><br>
                    </div>
                </div>
            </div>
            <table class="display" id="myTable" style="width:100%" >
                ...
                <tbody>
                    <%
                            ...
                            List<Student> stdlst = studentdao.viewAllStudentsUsingMapperClass();
...
<div class="col-md-12 text-center">
       <button type="button" class="btn btn-dark btn-secondary"><a href="AdminDashboard.jsp"> Back </a></button>
</div>
</body>
</html>