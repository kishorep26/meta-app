    ...
    <section class="form my-3 mx-3">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-lg-5">
                    <img src="images/institute-login.jpeg" class="img-fluid" alt="institute-login">
                </div>
                <div class="col-lg-7 px-5 pt-5">
                    <h1 class="font-weight-bold py-3"> Welcome Institute! </h1>    
                    ...
                    <form method="post" action="ValidateInstitute.jsp">
                        ...
                        <p>
                            Don't have an account? <a href="InstituteRegistration.jsp">Register here</a> 
                        </p>
                    </form>
                </div>
            </div>
